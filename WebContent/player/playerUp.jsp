            ...
            <div class="col-md-9">
               <div class="list-group">
                  ...
                  <div class="list-group-item">
                     <form method="post" action="playerupproc.jsp">
                     
                     <table>
                     	<tr>
                     		<td>
                        <div class="form-group">
                           <label>선수 번호</label><br>
                           <%=p_no %>
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" name="t_no" value="<%=t_no %>">
                        </div> 
                            <div class="form-group">
                           <label>선수이름</label><br>
                           ...
                           <input type="text" name="p_birth" value="<%=p_birth %>">
                        </div> 
                        ...
                        <div class="form-group">
                           <label>등번호</label><br>
                           <input type="text" name="b_num" value="<%=b_num %>">
                        </div>
