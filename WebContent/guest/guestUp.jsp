...
String birth = request.getParameter("g_birth");
				...
				<div class="col-md-9">
					<div class="list-group">
						...
						<div class="list-group-item">
							<form action="guestupproc.jsp" method="post" >
								<!-- 아이디-->
								...
								<div class="form-group">
									<label>이름</label>
									<input type="text" name="g_name" class="form-control" value="<%=name %>">
								</div> 																
								<div class="form-group">
									<label>비밀번호</label>
									<input type="password" name="g_pwd" class="form-control">
								</div>

								<!-- 연락처-->
								<div class="form-group">
									<label>생년월일</label>
									<input type="text" name="g_birth" class="form-control" value="<%=birth %>">
								</div>
								
								<div class="form-group">
									<label>주소</label>
									<input type="text" name="g_address" class="form-control" value="<%=address %>">
								</div>
