...
function funcdel(no){
   ...
   if(message = true){
      location.href = "directordel.jsp?d_no=" + no;
      alert("정상적으로 삭제되었습니다")
   }else{
...
function funcup(no,team,name,pwd){
   location.href = "directorUp.jsp?d_no=" + no +
         "&t_name=" + team +
         "&d_name=" + name +
         "&d_pwd=" + pwd;
}
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="navbar-nav"><!--왼쪽 nav정렬 -->
         ...
         <a class="nav-item nav-link active" href="../director/director.jsp">감독관리</a>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-3">
            ...
            <div class="col-md-9">
            <div class="list-group">
               <a href="#" class="list-group-item active">감독명단</a>
                     ...
                     <table class="table">
                        <tbody>
                           <tr>
                              ...
                              <th class="mobile"style="width:80px; text-align: center;">프로필사진</th>
                              <th class="mobile"style="width:120px; text-align: center;">이름</th>
                              <th class="mobile"style="width:120px; text-align: center;">구단명</th>
                              <th class="mobile"style="width:120px; text-align: center;">비밀번호</th>
                              <th class="mobile"style="width:120px; text-align: center;">수정/삭제</th>
                           </tr>
                           <%
                              ArrayList dilist = (ArrayList<DirectorDto>)processDao.DirectorDataAll();
                           %>
                           <c:set var="dilist" value="<%=dilist%>" />
                           ...
                           <c:forEach var="di" items="<%=dilist%>">
                              <tr>
                                 <td class="mobile"style="width:80px; text-align: center;">
                                 <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                                 <fmt:formatNumber value="${di.d_no/10}" type="number" pattern="#,##0"/>
                                 
                                 </td>
                                 <td class="mobile"style="width:120px; text-align: center;">
                                 <img src="../director/directorimg/${di.d_image}">
                                 
                                 </td>
                                 <!-- #나중에 달력 만들때 원하는 일 수만큼 잘라서 쓰기.# -->
                                 <td class="mobile"style="width:120px; text-align: center;">${di.d_name}</td>
                                 <td class="mobile"style="width:120px; text-align: center;">${di.t_name}</td>
                                 <td class="mobile"style="width:120px; text-align: center;">${di.d_pwd}</td>
                                 <td class="mobile"style="width:120px; text-align: center;">
                                 
                                 |&nbsp;&nbsp;<input type="button" value="수정" class="btn btn-primary" onclick="javascript:funcup('${di.d_no}','${di.t_name}','${di.d_name}','${di.d_pwd}',)">&nbsp;&nbsp;|
                                 <br>
                                                                                          
                                 <br>
                                 |&nbsp;&nbsp;<input type="button" value="삭제" class="btn btn-secondary" onclick="javascript:funcdel('${di.d_no}')">&nbsp;&nbsp;|            
                                 <br>                  
